...
#   Opcionales
    ...
    op = int(input("Ingrese la estrategia a utilizar: 1-Martingala, 2-D'Alembert, 3-Fibonacci, 4-Buscar otra: "))
    if op == 1:
        estrategia = 'm'
    ...
    if op == 1 and (estrategia == 'd' or estrategia == 'm' or estrategia == 'f'):
    ...
    elif op == 4 and (estrategia == 'd' or estrategia == 'm' or estrategia == 'f'):
