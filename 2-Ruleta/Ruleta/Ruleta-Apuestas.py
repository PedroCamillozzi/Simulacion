...
#   Opcionales
    ...
    elif op == 2 and (estrategia == 'm' or estrategia == 'f' or estrategia == 'p'):
    ...
    elif op == 3 and (estrategia == 'm' or estrategia == 'f' or estrategia == 'p'):
    ...
    elif op == 5 and (estrategia == 'm' or estrategia == 'f' or estrategia == 'p'):
